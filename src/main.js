...
document.getElementById("show-dato").addEventListener("click", () => {

  document.getElementById("datito").innerHTML += `¿Sabías que los pokémon tipo agua son el ${window.computeStats(data)} % de la región de Kanto?`
